<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
	...
	<ul class="menu-inner py-1">
		...
		{/foreach}
		{* <li class="menu-item {if $m=='home'}active open{/if}">
			<a href="javascript:void(0);" class="menu-link menu-toggle">
				<i class="menu-icon tf-icons bx bx-home-circle"></i>
				<div >Trang chủ</div>
			</a>
			<ul class="menu-sub">
				<li class="menu-item {if $act=='index'}active{/if}">
		...
		<li class="menu-item {if $m=='manage'}active open{/if}">
			<a href="javascript:void(0);" class="menu-link menu-toggle">
			...
			<ul class="menu-sub">
				<li class="menu-item {if $act=='menu'}active{/if}">
					<a href="/a-quan-ly-menu" class="menu-link">
						<div >Quản lý menu</div>
					</a>
				</li>
				<li class="menu-item {if $act=='page'}active{/if}">
					<a href="/a-quan-ly-giao-dien" class="menu-link">
