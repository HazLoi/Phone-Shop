<?php /* Smarty version Smarty-3.1.18, created on 2025-02-09 14:03:07
         compiled from "D:\a_project_2024\General\admin\templates\project01\home\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:27311143667a8532baf3544-43268882%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e5ac1314b70848075deb1b0f2f44fe3c268548eb' => 
    array (
      0 => 'D:\\a_project_2024\\General\\admin\\templates\\project01\\home\\index.tpl',
      1 => 1707925260,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '27311143667a8532baf3544-43268882',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_67a8532bb276d0_77297536',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_67a8532bb276d0_77297536')) {function content_67a8532bb276d0_77297536($_smarty_tpl) {?><div class="layout-page">
                ...
                <div class="card-body">
                  <div class="card-title d-flex align-items-start justify-content-between">
                    <div class="avatar flex-shrink-0">
                      <img src="<?php echo $_smarty_tpl->tpl_vars['domain']->value;?>
public/assets/img/icons/unicons/chart-success.png" alt="chart success"
                        class="rounded" />
                    </div>
                    <div class="dropdown">
              ...
              <div class="tab-content p-0">
                <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                  <div class="d-flex p-4 pt-3">
                    <div class="avatar flex-shrink-0 me-3">
                      <img src="<?php echo $_smarty_tpl->tpl_vars['domain']->value;?>
public/assets/img/icons/unicons/wallet.png" alt="User" />
                    </div>
                    <div>
            ...
            <div class="card-body">
              <ul class="p-0 m-0">
                <li class="d-flex mb-4 pb-1">
                  <div class="avatar flex-shrink-0 me-3">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['domain']->value;?>
public/assets/img/icons/unicons/paypal.png" alt="User" class="rounded" />
                  </div>
                  <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                ...
                <li class="d-flex mb-4 pb-1">
                  <div class="avatar flex-shrink-0 me-3">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['domain']->value;?>
public/assets/img/icons/unicons/wallet.png" alt="User" class="rounded" />
                  </div>
                  <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                ...
                <li class="d-flex mb-4 pb-1">
                  <div class="avatar flex-shrink-0 me-3">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['domain']->value;?>
public/assets/img/icons/unicons/chart.png" alt="User" class="rounded" />
                  </div>
                  <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                ...
                <li class="d-flex mb-4 pb-1">
                  <div class="avatar flex-shrink-0 me-3">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['domain']->value;?>
public/assets/img/icons/unicons/cc-success.png" alt="User" class="rounded" />
                  </div>
                  <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
...
public/assets/img/icons/unicons/wallet.png" alt="User" class="rounded" />
                ...
                <li class="d-flex">
                  <div class="avatar flex-shrink-0 me-3">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['domain']->value;?>
public/assets/img/icons/unicons/cc-warning.png" alt="User" class="rounded" />
                  </div>
                  <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
